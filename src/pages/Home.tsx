    ...
    >
      <div className="tile-image-container">
        ...
        <button 
          ...
          style={{ position: 'absolute', bottom: '12px', right: '12px', width: '32px', height: '32px', padding: 0, borderRadius: '16px', background: 'rgba(255,255,255,0.8)', backdropFilter: 'blur(4px)', border: '1px solid rgba(0,0,0,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: item.liked ? 'var(--danger)' : 'var(--text-muted)', zIndex: 10 }}
        >
      ...
      <div style={{ padding: '12px 16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '4px' }}>
          <span style={{ fontSize: '9px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px', background: 'var(--primary-glow)', color: '#000', padding: '2px 6px', borderRadius: '4px', marginBottom: '2px', textAlign: 'center', display: 'inline-block', alignSelf: 'flex-start' }}>
            {item.category}
          </span>
                      ...
                      {normalItems.map((item, index) => {
                        ...
                        return (
                          <Fragment key={item.id}>
                            ...
                            {inlinePromo && (
                              <div style={{ gridColumn: '1 / -1', display: 'flex', flexDirection: 'column', gap: '16px', margin: '16px 0', alignItems: 'center' }}>
                                <div style={{ width: '100%', maxWidth: inlinePromo.width === 'half' ? '500px' : 'none', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                  ...
                                  {inlinePromo.itemIds && inlinePromo.itemIds.length > 0 && (
                                    <div className="hide-scrollbar" style={{ display: 'flex', overflowX: 'auto', gap: '16px', padding: '4px 0', scrollSnapType: 'x mandatory' }}>
                                      {inlinePromo.itemIds.map((id: string) => {
                                        ...
                                        return (
                                          <div key={id} style={{ width: inlinePromo.width === 'half' ? '200px' : '280px', flexShrink: 0, scrollSnapAlign: 'start' }}>
