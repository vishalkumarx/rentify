        ...
        {loading ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {requests.slice(0, visibleCount).map(req => (
              <div key={req.id} style={{ padding: '24px 0', borderBottom: '1px solid var(--surface-border)', display: 'flex', flexDirection: 'column', gap: '16px', position: 'relative', opacity: req.suspended ? 0.7 : 1 }}>
