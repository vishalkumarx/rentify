                            ...
                            <div style={{ display: 'flex', gap: '12px' }}>
                              ...
                              <div style={{ flex: 1 }}>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '4px', marginTop: '6px', marginLeft: '8px' }}>
                                  ...
                                  {!isReply && (
                                    <button onClick={() => setReplyingTo(c.id)} style={{ background: 'none', border: 'none', color: 'var(--text-muted)', fontSize: '12px', fontWeight: 600, cursor: 'pointer', padding: 0, textAlign: 'left', marginLeft: '4px' }}>
                                      Reply
                                    </button>
                                  )}
                                </div>
