          ...
          isSelectMode ? (
            <div style={{ display: 'flex', gap: '8px' }}>
              <button
                ...
                style={{ width: 'auto', padding: '4px 12px', borderRadius: '14px', border: 'none', background: selectedConvIds.size > 0 ? 'var(--danger)' : 'var(--surface-border)', color: selectedConvIds.size > 0 ? '#fff' : 'var(--text-muted)', fontSize: '13px', fontWeight: 600, cursor: selectedConvIds.size > 0 ? 'pointer' : 'not-allowed', display: 'flex', alignItems: 'center', gap: '4px' }}
              >
                Delete {selectedConvIds.size > 0 ? `(${selectedConvIds.size})` : ''}
              </button>
              <button
                onClick={exitSelectMode}
                style={{ width: 'auto', padding: '4px 12px', borderRadius: '14px', border: '1px solid var(--surface-border)', background: 'transparent', color: 'var(--text-muted)', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}
              >
                Cancel
              </button>
            </div>
            ...
            <button
              ...
              style={{ width: 'auto', padding: '4px 12px', borderRadius: '14px', border: '1px solid var(--surface-border)', background: 'transparent', color: 'var(--text-main)', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}
            >
              Edit
            </button>
          )
