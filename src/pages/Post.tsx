          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            {images[0] ? (
              <div style={{ position: 'relative', height: '240px' }}>
                ...
                <button type="button" onClick={() => removeImage(0)} style={{ position: 'absolute', top: '12px', right: '12px', width: '32px', height: '32px', minWidth: '32px', minHeight: '32px', flexShrink: 0, aspectRatio: '1 / 1', padding: 0, borderRadius: '16px', background: 'rgba(0,0,0,0.6)', border: 'none', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'none' }}>
                  <X size={18} />
                </button>
              </div>
            ) : (
            ...
            <div style={{ display: 'grid', gridTemplateRows: '1fr 1fr', gap: '12px' }}>
              ...
              {images[1] ? (
                <div style={{ position: 'relative', height: '100%' }}>
                  ...
                  <button type="button" onClick={() => removeImage(1)} style={{ position: 'absolute', top: '8px', right: '8px', width: '28px', height: '28px', minWidth: '28px', minHeight: '28px', flexShrink: 0, aspectRatio: '1 / 1', padding: 0, borderRadius: '14px', background: 'rgba(0,0,0,0.6)', border: 'none', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'none' }}>
                    <X size={16} />
                  </button>
                </div>
              ) : (
              ...
              {images[2] ? (
                <div style={{ position: 'relative', height: '100%' }}>
                  ...
                  <button type="button" onClick={() => removeImage(2)} style={{ position: 'absolute', top: '8px', right: '8px', width: '28px', height: '28px', minWidth: '28px', minHeight: '28px', flexShrink: 0, aspectRatio: '1 / 1', padding: 0, borderRadius: '14px', background: 'rgba(0,0,0,0.6)', border: 'none', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'none' }}>
                    <X size={16} />
                  </button>
                </div>
              ) : (
